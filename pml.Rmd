...
Data are read from the disk and cleaned:
  * Remove cols that are irrelevant for the classification (the first 7 ones)
  * Remove cols that contains only NAs or Near Zero Variance
...
Accuracy is improved when using Cross-Validation versus not using Cross Validation (XXX versus YYY)
The model with 10-fold Cross Validation will missclassified only a few part of the sample
